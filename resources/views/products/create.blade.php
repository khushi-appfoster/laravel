   ...
   <div class = "card border-0 shadow-lg my-4">
    ...
    <div class = "card-body">
      <div class = "mb-3">
        ...
        <input value = "{{ old('uname') }}" type = "text" class ="@error('uname') is-invalid @enderror 
...
<div class = "mb-3">
        ...
        <input value = "{{ old('pname') }}" type = "text" class = "@error('pname') is-invalid @enderror form-control form-control-lg"  placeholder = "ProjectName" name = "pname">
        @error('pname')
        <p class = "invalid-feedback">{{ $message }}</p>
        @enderror
</div>
<div class = "mb-3">
        ...
        <input value = "{{ old('projectid') }}"type = "text" class = "@error('projectid') is-invalid @enderror form-control form-control-lg"  placeholder = "ProjectID" name = "pid">
        @error('projectid')
        <p class = "invalid-feedback">{{ $message }}</p>
        @enderror
</div>
